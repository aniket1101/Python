...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        the_genes = get_num_genes(person, one_gene, two_genes)
        if people[person]["mother"] is None:
            gene_prob = PROBS["gene"][the_genes]
        else:
            mother_prob = parent_prob(people[person]["mother"], one_gene, two_genes)
            father_prob = parent_prob(people[person]["father"], one_gene, two_genes)
        ...
        trait_prob = PROBS["trait"][the_genes][trait]
...
def parent_prob(parent, one_gene, two_genes):
    ...
    num_genes = get_num_genes(parent, one_gene, two_genes)
    
    return(0.01 if num_genes == 0
            else 0.5 if num_genes == 1
            else 0.99)
